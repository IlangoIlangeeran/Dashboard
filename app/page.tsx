...
export default function Home() {
  ...
  // Replace with your own logic for checking if the user is signed in
  useEffect(() => {
    const checkAuthentication = async () => {
      try {
        ...
        setIsSignedIn(data.signedIn); // Assuming the response has a 'signedIn' boolean
      } catch (error) {
  ...
  return (
    <div className='scroll-smooth'>
      ...
      <div className='flex-col overflow-hidden bg-dot-black/[0.2] relative flex items-center justify-center w-full dark:bg-black bg-white'>
        ...
        {from === 'bradi.tech' && (
          <Link href='https://www.bradi.tech' className='fixed bottom-5 right-5 z-50 text-white'>
