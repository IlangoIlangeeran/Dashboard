    ...
    const fetchProjects = async () => {
      try {
        ...
        if (data.length === 0) {
          router.push('/tickets');
          toast({
            title: 'You need to create a project to get started!',
  ...
  const cardsData = [
    ...
    },
    {
      ...
      value: loadingTickets
        ...
        : noTickets
        ? '0'
        : tickets.filter((ticket) => ticket.status === 'inprogress').length.toString(),
      status: 'In progress',
    ...
    },
    {
      ...
      value: loadingTickets
        ...
        : noTickets
        ? '0'
        : tickets.filter((ticket) => ticket.status === 'active').length.toString(),
      status: 'active',
