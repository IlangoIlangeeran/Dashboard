...
const TechInfo = [
  ...
  { id: 'mui', label: 'MaterialUI' },
  { id: 'nodejs', label: 'NodeJS' },
  { id: 'expressjs', label: 'ExpressJS' },
  { id: 'postgres', label: 'PostgresSQL' },
...
const CreateProject = () => {
  ...
  // Fetch projects from API (if the user already has a project, they should not create a new one)
  useEffect(() => {
  ...
  // If projects already exist, show a message and redirect
  if (projects.length > 0) {
    router.push('/tickets');
    toast({
      title: 'Nooo! You have a project already!',
      description: <div>You do not have access to create another project!</div>,
    });
  }
